Appendix 1 - Lab Environment Details
================================================================================


This section acts as reference for the configuration and resources used in multiple AppWorld SSL Orchestrator labs. The corresponding UDF blueprint supports both outbound and inbound SSL visibility and inspection use-cases.
