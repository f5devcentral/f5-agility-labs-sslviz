...
You will create a rule to send decrypted traffic to the TAP service for visual confirmation in the Wireshark console. Furthermore, to meet your organization's privacy policy requirements, you will create a decryption bypass rule for sensitive banking and personal health-related URL categories.
